...
public class RightFiveCargo extends ModeBase {
  ...
  private static final Pose2d
    ...
    POSE_CARGO_3 = new Pose2d(.3, 3.0, new Rotation2d(95.0)),
    POSE_HUMAN_PLAYER = new Pose2d(0.78, 6.9, Rotation2d.fromDegrees(40)),
    POSE_SHOOT_4_5 = new Pose2d(0.1, 3.6, new Rotation2d(82.0));

  private static final Translation2d
    TRANSLATION_CARGO_2 = new Translation2d(1.05, 0.6);

  public static final Trajectory
    CARGO_2_3 = TrajectoryGenerator.generateTrajectory(POSE_START, List.of(TRANSLATION_CARGO_2), POSE_CARGO_3, FORWARDS),
  ...
  public RightFiveCargo() {
    addCommands(
      ...
      deadline(
        ...
        new WaitCommand(1.5).andThen(new TurretPosition(215.0, 5.0))
      ),
      parallel(
