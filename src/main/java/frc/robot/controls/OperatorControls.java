...
public class OperatorControls {    
  ...
  public OperatorControls() {
    ...
    new JoystickButton(operator, Button.kRightBumper.value).whenPressed(new ShooterTune());
    new JoystickButton(operator, Button.kRightBumper.value).whenReleased(new ShooterOpenLoop(0.0));
